...
public class BookEvent {
    public enum Type {
        CREATED, REMOVED, READ, RATED, REVIEWED, RATING_INC, SYSTEM_RESET
    };
    ...
    public static BookEvent systemReset() {
    	return new BookEvent(Type.SYSTEM_RESET);
    }
    ...
    public String toString() {
        return "BookEvent [type=" + type + ", occurred=" + DateUtil.formatISO8601(occurred) + ", book=" + book + ", review="
